...
/**
 *  \file       core/modules/multidb/doc/pdf_standard.modules.php
 *  \ingroup    multidb
...
/**
 *	Class to manage PDF template standard_mudb
 */
class pdf_standard_mudb extends ModelePDFMuDb
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
		if (!empty($conf->global->MAIN_GENERATE_MUDB_WITH_PICTURE))
		{
		...
		*/
		...
		if ($conf->multidb->dir_output.'/mudb') {
			$object->fetch_thirdparty();

			// Definition of $dir and $file
			if ($object->specimen) {
				$dir = $conf->multidb->dir_output.'/mudb';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->multidb->dir_output.'/mudb/'.$objectref;
