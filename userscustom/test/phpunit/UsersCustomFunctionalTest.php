...
/**
 * \file    test/phpunit/UsersCustomFunctionalTest.php
 * \ingroup userscustom
...
/**
 * Class UsersCustomFunctionalTest
 *
 ...
 *
 * @package Testuserscustom
 */
class UsersCustomFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	public function testModuleEnabled()
	{
		...
		if (strstr($module_status_image->attribute('src'), 'switch_off.png')) {
			// Enable the module
			$this->byHref('modUsersCustom')->click();
		} else {
			// Disable the module
			$this->byHref('modUsersCustom')->click();
			// Reenable the module
	...
	{
		$this->url('/custom/userscustom/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('userscustom/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/userscustom/admin/about.php');
		$this->authenticate();
		return $this->assertContains('userscustom/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('userscustomwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modUsersCustom_UsersCustomTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modUsersCustom_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
